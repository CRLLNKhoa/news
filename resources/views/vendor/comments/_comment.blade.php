    ...
    <div class="media-body">
        ...
        <div>
            ...
            @can('edit-comment', $comment)
                <span data-toggle="modal" data-target="#comment-modal-{{ $comment->getKey() }}" style="cursor: pointer;color: blue;"><i class="fas fa-edit"></i> Chỉnh sửa</span>
            @endcan
            @can('delete-comment', $comment)
                <a href="{{ route('comments.destroy', $comment->getKey()) }}" onclick="event.preventDefault();document.getElementById('comment-delete-form-{{ $comment->getKey() }}').submit();" style="cursor: pointer;color: red;"><i class="fas fa-trash"></i> Xóa</a>
